...
The 'dbx_data_pipeline' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] dbx_data_pipeline_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/dbx_data_pipeline.job.yml). The schedule
